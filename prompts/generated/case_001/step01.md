# Case case_001 — Step 1: Story Front Generation（故事前半段生成）

## 操作說明
1. 將下方「System Prompt」貼入 LLM 的 system prompt 欄位
2. 將「User Message」貼入對話框送出
3. 將 LLM 回應複製
4. 執行：`python tools/save_response.py case_001 1`
   然後貼入回應
...
回應儲存位置：`D:\projects\bagua\data\cases\case_001\story_front.txt`
